  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          // changed min-h-svh to min-h-dvh to fix issue with sidebar not being full height on mobile
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "transition-[width] duration-200 ease-out-quart relative w-(--sidebar-width) bg-transparent",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-out-quart md:flex",
          side === "left"
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon-sm"
      className={cn("pointer-coarse:touch-hitbox", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
